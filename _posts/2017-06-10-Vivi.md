...
<img alt="Vivi" src="../images/2017-06-10-Vivi/education.jpg" width="600">
...
<img alt="Vivi Devices" src="../images/2017-06-10-Vivi/vivi_team.jpg" width="600">
...
<img alt="Vivi Devices" src="../images/2017-06-10-Vivi/vivi_devices.jpg" width="600">
...
2. Identified the version number the operating system using the System Information app on the computer. The machine being utilised for converting VIVI had the OS version of *10.0.14393 Build 14393 (Anniversary Update)*.
    ...
    <img alt="Windows Version" src="../images/2017-06-10-Vivi/os-version.png" width="600">
...
<img alt="Running the Desktop App Converter" src="../images/2017-06-10-Vivi/ran_converter.png" width="600">
...
<img alt="Converter Output" src="../images/2017-06-10-Vivi/output_files.png" width="600">
...
1. Double-click the .pfx file, and the Certificate Import Wizard opens. Choose *Local Machine* as the store location.
    ...
    <img alt="Certificate Import Wizard Welcome page" src="../images/2017-06-10-Vivi/certificate.png" width="600">
...
2. Add your .pfx file to **Trusted Root Certification Authorities**.     
    ...
    <img alt="Certificate Import Wizard Certificate Store page" src="../images/2017-06-10-Vivi/certificate.png" width="600">
...
3. Double-click the .appx file and clicked Install to continue.
    ...
    <img alt="Install Appx" src="../images/2017-06-10-Vivi/install_appx.png" width="600">
...
<img alt="Submit Error" src="../images/2017-06-10-Vivi/submit_error.png" width="600">
...
<img alt="Store Visibility" src="../images/2017-06-10-Vivi/store_visibility.png" width="600">
